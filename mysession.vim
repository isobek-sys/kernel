...
silent only
cd ~/Documents/projects/kernel
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 include/screen.h
badd +18 srcs/kernel/printf.c
badd +20 include/printf.h
argglobal
silent! argdel *
argadd include/screen.h
edit include/screen.h
